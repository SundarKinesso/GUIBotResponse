...
class Tairo_Chatterbot_GUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("Sizmek Workflow GUI Bot")
    ...
    def initialize(self):
        ...
        Set window layout.
        """
        self.trainer.train("chatterbot.corpus.english.greetings")#you can change to any language as long as it available in chatterbot corpus
